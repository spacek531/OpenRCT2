...
enum
{
    ...
    SPR_G2_DIAG_BRAKES_START = SPR_G2_SINGLE_RAIL_END,
    ...
    SPR_G2_LIMLAUNCHED_DIAG_BRAKES = SPR_G2_LOOPING_DIAG_BRAKES + 2,
    SPR_G2_BM_INVERTED_DIAG_BRAKES = SPR_G2_LIMLAUNCHED_DIAG_BRAKES + 6,
