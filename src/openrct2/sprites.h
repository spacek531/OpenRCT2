...
enum
{
    ...
    SPR_G2_TAB_DISABLED = SPR_G2_BEGIN + 79,

    SPR_G2_GIGA_RC_BOOSTER_NE_SW = SPR_G2_BEGIN + 80,
    SPR_G2_GIGA_RC_BOOSTER_NW_SE = SPR_G2_BEGIN + 81,
    SPR_G2_BM_BOOSTER_NE_SW = SPR_G2_BEGIN + 82,
    SPR_G2_BM_BOOSTER_NW_SE = SPR_G2_BEGIN + 83,

    SPR_G2_TOOLBAR_MUTE = SPR_G2_BEGIN + 86,
    SPR_G2_TOOLBAR_MUTE_PRESSED = SPR_G2_BEGIN + 87,
    SPR_G2_TOOLBAR_UNMUTE = SPR_G2_BEGIN + 88,
    SPR_G2_TOOLBAR_UNMUTE_PRESSED = SPR_G2_BEGIN + 89,

    SPR_G2_MINI_RC_BOOSTER_NE_SW = SPR_G2_BEGIN + 90,
    SPR_G2_MINI_RC_BOOSTER_NW_SE = SPR_G2_BEGIN + 91,

    SPR_G2_MINIATURE_RAILWAY_QUARTER_TURN_3_TILES_SW_SE_PART_3 = SPR_G2_BEGIN + 92,

    SPR_G2_MINIATURE_RAILWAY_BEGIN = SPR_G2_BEGIN + 93,
    ...
    SPR_G2_MINIATURE_RAILWAY_LAST = SPR_G2_BEGIN + 104,

    SPR_G2_SEARCH = SPR_G2_BEGIN + 105,

    SPR_G2_SURFACE_GLASSY_RECOLOURABLE = SPR_G2_BEGIN + 106,
    ...
    SPR_G2_EYEDROPPER = SPR_G2_BEGIN + 111,
    SPR_G2_CHAT = SPR_G2_BEGIN + 112,

    SPR_G2_MAP_NORTH = SPR_G2_BEGIN + 113,
    SPR_G2_MAP_NORTH_PRESSED = SPR_G2_BEGIN + 114,
    SPR_G2_MAP_WEST = SPR_G2_BEGIN + 115,
    SPR_G2_MAP_WEST_PRESSED = SPR_G2_BEGIN + 116,
    SPR_G2_MAP_SOUTH = SPR_G2_BEGIN + 117,
    SPR_G2_MAP_SOUTH_PRESSED = SPR_G2_BEGIN + 118,
    SPR_G2_MAP_EAST = SPR_G2_BEGIN + 119,
    SPR_G2_MAP_EAST_PRESSED = SPR_G2_BEGIN + 120,

    SPR_G2_TOOLBAR_MULTIPLAYER = SPR_G2_BEGIN + 121,
    SPR_G2_TOOLBAR_MULTIPLAYER_PRESSED = SPR_G2_BEGIN + 122,
    SPR_G2_MULTIPLAYER_SYNC = SPR_G2_BEGIN + 123,
    SPR_G2_MULTIPLAYER_DESYNC = SPR_G2_BEGIN + 124,

    SPR_G2_SIMULATE = SPR_G2_BEGIN + 125,
    SPR_G2_RCT1_SIMULATE_BUTTON_0 = SPR_G2_BEGIN + 126,
    SPR_G2_RCT1_SIMULATE_BUTTON_1 = SPR_G2_BEGIN + 127,
    SPR_G2_RCT1_SIMULATE_BUTTON_2 = SPR_G2_BEGIN + 128,
    SPR_G2_RCT1_SIMULATE_BUTTON_3 = SPR_G2_BEGIN + 129,

    SPR_G2_LAND_TOOL_SIZE_6 = SPR_G2_BEGIN + 130,

    SPR_G2_MOUNTAIN_TOOL_EVEN = SPR_G2_BEGIN + 131,
    SPR_G2_MOUNTAIN_TOOL_ODD = SPR_G2_BEGIN + 132,

    SPR_G2_SCENERY_SCATTER_LOW = SPR_G2_BEGIN + 133,
    ...
    SPR_G2_DISKO_BEGIN = SPR_CSG_END,
    SPR_G2_DISKO_TRACK_FLAT = SPR_G2_DISKO_BEGIN,
    SPR_G2_DISKO_TRACK_GENTLE = SPR_G2_DISKO_TRACK_FLAT + 2,
    SPR_G2_DISKO_TRACK_STEEP = SPR_G2_DISKO_TRACK_GENTLE + 12,
    SPR_G2_DISKO_TRACK_VERTICAL = SPR_G2_DISKO_TRACK_STEEP + 16,
    SPR_G2_DISKO_TRACK_FLAT_DIAGONAL = SPR_G2_DISKO_TRACK_VERTICAL + 12,
    SPR_G2_DISKO_TRACK_GENTLE_DIAGONAL = SPR_G2_DISKO_TRACK_FLAT_DIAGONAL + 4,
    SPR_G2_DISKO_TRACK_STEEP_DIAGONAL = SPR_G2_DISKO_TRACK_GENTLE_DIAGONAL + 12,
    SPR_G2_DISKO_TRACK_FLAT_TO_STEEP = SPR_G2_DISKO_TRACK_STEEP_DIAGONAL + 12,
    SPR_G2_DISKO_TRACK_QUARTER_LOOP = SPR_G2_DISKO_TRACK_FLAT_TO_STEEP + 32,

    SPR_RIDE_DESIGN_PREVIEW_DISKO_COASTER_TRACK = SPR_G2_PLACEHOLDER, // TODO: make sprites for preview
    SPR_RIDE_DESIGN_PREVIEW_DISKO_COASTER_SUPPORTS = SPR_G2_PLACEHOLDER,

    SPR_G2_DISKO_END = SPR_G2_DISKO_TRACK_QUARTER_LOOP + 16,

    SPR_IMAGE_LIST_BEGIN = SPR_G2_DISKO_END,
