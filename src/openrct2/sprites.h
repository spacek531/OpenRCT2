...
enum
{
    ...
    SPR_G2_DISKO_BEGIN = SPR_G2_CHAR_END,
    ...
    SPR_G2_DISKO_TRACK_DIAGONAL_FLAT = SPR_G2_DISKO_TRACK_VERTICAL + 12,
    SPR_G2_DISKO_TRACK_DIAGONAL_GENTLE = SPR_G2_DISKO_TRACK_DIAGONAL_FLAT + 4,
    SPR_G2_DISKO_TRACK_DIAGONAL_STEEP = SPR_G2_DISKO_TRACK_DIAGONAL_GENTLE + 12,
    SPR_G2_DISKO_TRACK_FLAT_TO_STEEP = SPR_G2_DISKO_TRACK_DIAGONAL_STEEP + 12,
    SPR_G2_DISKO_TRACK_QUARTER_LOOP = SPR_G2_DISKO_TRACK_FLAT_TO_STEEP + 32,

    SPR_G2_DISKO_END = SPR_G2_DISKO_TRACK_QUARTER_LOOP + 24,
