...
enum
{
    ...
    SPR_G2_SINGLE_RAIL_END = SPR_G2_SINGLE_RAIL_LIFT_BEGIN + 80,

    SPR_G2_JUNIOR_DIAG_BRAKES_START = SPR_G2_SINGLE_RAIL_END,
    SPR_G2_JUNIOR_DIAG_BRAKES_END = SPR_G2_JUNIOR_DIAG_BRAKES_START + 6,

    SPR_G2_CORKSCREW_DIAG_BRAKES_START = SPR_G2_JUNIOR_DIAG_BRAKES_END,
    SPR_G2_CORKSCREW_DIAG_BRAKES_END = SPR_G2_CORKSCREW_DIAG_BRAKES_START + 6,

    SPR_G2_SLC_DIAG_BRAKES_START = SPR_G2_CORKSCREW_DIAG_BRAKES_END,
    SPR_G2_SLC_DIAG_BRAKES_END = SPR_G2_SLC_DIAG_BRAKES_START + 3,

    SPR_G2_END = SPR_G2_CORKSCREW_DIAG_BRAKES_END,
