...
const rct_trackdefinition TrackDefinitions[TrackElemType::Count] =
{
    ...
    { TRACK_NONE,                   TRACK_SLOPE_NONE,           TRACK_SLOPE_NONE,           TRACK_BANK_NONE,        TRACK_BANK_NONE,        0                  },  // TrackElemType::DiagBrakes
    { TRACK_NONE,                   TRACK_SLOPE_NONE,           TRACK_SLOPE_NONE,           TRACK_BANK_NONE,        TRACK_BANK_NONE,        0                  },  // TrackElemType::DiagBlockBrakes
};
...
const rct_trackdefinition FlatRideTrackDefinitions[TrackElemType::Count] =
{
    ...
    { TRACK_NONE,                   TRACK_SLOPE_NONE,           TRACK_SLOPE_NONE,           TRACK_BANK_NONE,        TRACK_BANK_NONE,        0                           },  // 257
    { TRACK_NONE,                   TRACK_SLOPE_NONE,           TRACK_SLOPE_NONE,           TRACK_BANK_NONE,        TRACK_BANK_NONE,        0                           },  // 258
};
// clang-format on
