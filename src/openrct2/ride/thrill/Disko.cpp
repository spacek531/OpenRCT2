    ...
    const TileElement* tileElement)
{
    ...
    metal_a_supports_paint_setup(
        ...
        support_locations_60_deg_up[direction][0], height, session->TrackColours[SCHEME_SUPPORTS]);
    metal_a_supports_paint_setup(
    ...
    const TileElement* tileElement)
{
    switch (trackSequence)
    {
        case 0:
            ...
            metal_a_supports_paint_setup(
                session, (direction & 1) ? METAL_SUPPORTS_FORK : METAL_SUPPORTS_FORK_ALT, 5 + (direction & 1),
                support_locations_60_deg_up_to_90_deg_up[direction][0], height, session->TrackColours[SCHEME_SUPPORTS]);
            metal_a_supports_paint_setup(
                session, (direction & 1) ? METAL_SUPPORTS_FORK : METAL_SUPPORTS_FORK_ALT, 8 - (direction & 1),
    ...
    switch (trackSequence)
    {
        ...
        case 3:
            switch (direction)
            {
                ...
                case 2:
                    sub_98197C_rotated(
                        session, direction, session->TrackColours[SCHEME_TRACK] | (SPR_G2_DISKO_TRACK_FLAT_TO_STEEP + 11), 0, 0,
                        32, 1, 98, height, 0, 27, height);
                    break;
                case 3:
                    sub_98197C_rotated(
    ...
    switch (trackSequence)
    {
        case 0:
            switch (direction)
            {
                ...
                case 1:
                    sub_98197C_rotated(
                        session, direction, session->TrackColours[SCHEME_TRACK] | (SPR_G2_DISKO_TRACK_FLAT_TO_STEEP + 20), 0, 0,
                        32, 1, 98, height, 0, 27, height);
                    break;
                case 2:
                    sub_98197C_rotated(
                        session, direction, session->TrackColours[SCHEME_TRACK] | (SPR_G2_DISKO_TRACK_FLAT_TO_STEEP + 24), 0, 0,
                        32, 1, 98, height, 0, 27, height);
                    break;
                case 3:
                    sub_98197C_rotated(
