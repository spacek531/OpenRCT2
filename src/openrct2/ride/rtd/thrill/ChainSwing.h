...
namespace OpenRCT2
{
constexpr RideTypeDescriptor ChainSwingRTD =
{
    .Category = RideCategory::thrill,
    .StartTrackPiece = TrackElemType::FlatTrack5x5,
    .TrackPaintFunctions = TrackDrawerDescriptor({
        .trackStyle = TrackStyle::chainSwing,
        .enabledTrackGroups = {},
        .extraTrackGroups = {},
    }),
    ...
    .flatRideAnimationType = FlatRideAnimationType::chainSwing,
    .OperatingSettings = { 1, 20 },
