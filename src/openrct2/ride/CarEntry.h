...
enum : uint64_t
{
    ...
    CAR_ENTRY_FLAG_SPINNING_COMBINED_WITH_NONSPINNING_DEPRECATED = 1
        << 14, // If the vehicle combines the spinning carriage and non-spinning undercarriage in the same sprite. Replaced by
               // the combination of CAR_ENTRY_FLAG_SPINNING and spinningSymmetries = 0
