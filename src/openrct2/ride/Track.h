...
const rct_track_sequence* get_track_def_from_ride(Ride* ride, int32_t trackType);
const rct_track_sequence* get_track_def_from_ride_index(ride_id_t rideIndex, int32_t trackType);
