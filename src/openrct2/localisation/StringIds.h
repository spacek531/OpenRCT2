...
enum
{
    ...
    STR_RIDE_NAME_SCENIC_RAILWAY_COASTER = 95,
    ...
    STR_RIDE_DESCRIPTION_SCENIC_RAILWAY_COASTER = 605,
    ...
    STR_RIDE_CONSTRUCTION_TRACK_SPEED = 6410,
    STR_RIDE_CONSTRUCTION_TRACK_SPEED_LIMIT_TIP = 6411,
