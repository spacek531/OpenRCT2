...
enum : uint16_t
{
    ...
    STR_SPEED_TOO_HIGH = 6626,
    STR_TRACK_DESIGN_SPEED_UNSERIALIZABLE = 6627,
    STR_RIDE_SET_VEHICLE_LEGACY_SPEED_FAIL = 6628,
    STR_OPTION_USE_LEGACY_SPEED = 6629,
    STR_OPTION_USE_LEGACY_SPEED_TIP = 6630,
