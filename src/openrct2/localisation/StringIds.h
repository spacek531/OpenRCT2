...
enum : uint16_t
{
    ...
    STR_TILE_INSPECTOR_TRACK_BRAKE = 6536,
    STR_RIDE_CONSTRUCTION_BLOCK_BRAKE_SPEED = 6537,
    STR_RIDE_CONSTRUCTION_BLOCK_BRAKE_SPEED_LIMIT_TIP = 6538,
    STR_TRACK_DESIGN_BLOCK_BRAKE_SPEED_RESET = 6539,
