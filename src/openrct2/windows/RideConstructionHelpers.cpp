...
{
    // broadcast INTENT_ACTION_RIDE_CONSTRUCTION_UPDATE_PIECES
    ...
    if (curve <= 8) // no specific piece selected
    {
...
bool window_ride_construction_update_state(
    track_type_t* _trackType, int32_t* _trackDirection, ride_id_t* _rideIndex, int32_t* _liftHillAndInvertedState,
