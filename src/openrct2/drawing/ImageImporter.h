...
namespace OpenRCT2::Drawing
{
    ...
    public:
        ...
        ImportResult Import(
            ...
            Palette palette = Palette::OpenRCT2, ImportFlags flags = ImportFlags::None, ImportMode mode = ImportMode::Default,
            GamePalette spritePalette = StandardPalette) const;
        ImportResult Import(
            const Image& image, int32_t offsetX = 0, int32_t offsetY = 0, Palette palette = Palette::OpenRCT2,
            ImportFlags flags = ImportFlags::None, ImportMode mode = ImportMode::Default,
            GamePalette spritePalette = StandardPalette) const;
    ...
    private:
        ...
        static std::vector<int32_t> GetPixels(
            ...
            Palette palette, ImportFlags flags, ImportMode mode, GamePalette spritePalette);
