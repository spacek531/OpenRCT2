            ...
            case TileElementType::Track:
                switch (widgetIndex)
                {
                    ...
                    case WIDX_TRACK_CHECK_BRAKE_CLOSED:
                        TrackSetBrakeClosed(windowTileInspectorSelectedIndex, !tileElement->AsTrack()->GetBrakeClosed());
                        break;
    ...
    void OnPrepareDraw() override
    {
        ...
        switch (tileElement->GetType())
        {
            ...
            case TileElementType::Track:
                ...
                SetCheckboxValue(WIDX_TRACK_CHECK_BRAKE_CLOSED, tileElement->AsTrack()->GetBrakeClosed());
