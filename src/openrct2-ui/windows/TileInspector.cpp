...
static rct_widget TrackWidgets[] = {
    ...
    { WindowWidgetType::Checkbox,         1,  GBBF(WH - TRA_GBPT, 0, 3),  STR_TILE_INSPECTOR_TRACK_BRAKE,           STR_NONE }, // WIDX_PATH_CHECK_BLOCK_BRAKE_CLOSED
            ...
            switch (widgetIndex)
            {
                ...
                case WIDX_TRACK_CHECK_BLOCK_BRAKE_CLOSED:
                    window_tile_inspector_track_set_block_brake(
                        windowTileInspectorSelectedIndex, !tileElement->AsTrack()->BrakeClosed());
                    break;
...
static void window_tile_inspector_invalidate(rct_window* w)
{
    ...
    switch (w->tileInspectorPage)
    {
        ...
        case TileInspectorPage::Track:
            ...
            WidgetSetCheckboxValue(w, WIDX_TRACK_CHECK_BLOCK_BRAKE_CLOSED, tileElement->AsTrack()->BrakeClosed());
