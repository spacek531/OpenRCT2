...
private:
    ...
    SpecialElementsList SpecialElementList;
...
public:
    ...
    void OnDropdown(WidgetIndex widgetIndex, int32_t selectedIndex) override
    {
        ...
        RideConstructionInvalidateCurrentTrack();
        _currentTrackPrice = MONEY64_UNDEFINED;
        track_type_t trackPiece = SpecialElementList.Elements[selectedIndex].TrackType;
        switch (trackPiece)
        {
    ...
    void UpdateWidgets()
    {
        ...
        if (SpecialElementList.HasActiveElements)
        {
    ...
    void UpdatePossibleRideConfigurations()
    {
        ...
        SpecialElementList = BuildSpecialElementsList(
...
private:
    ...
    void ShowSpecialTrackDropdown(Widget* widget)
    {
        ...
        for (int32_t i = 0; i < SpecialElementList.NumElements; i++)
        {
            track_type_t trackPiece = SpecialElementList.Elements[i].TrackType;
        ...
        WindowDropdownShowTextCustomWidth(
            ...
            SpecialElementList.NumElements, widget->width());

        for (int32_t i = 0; i < SpecialElementList.NumElements; i++)
        {
            Dropdown::SetDisabled(i, SpecialElementList.Elements[i].Disabled);
        }
